...
<?php echo form_open_multipart('secure/company/add', array('class'=>'form-horizontal')); ?>
	...
	<div class="panel panel-flat">
							...
							<div class="panel-body">
									...
									<div class="col-md-6">
										<fieldset>
                                            ...
                                            <div class="form-group">
												<label class="col-lg-3 control-label">Company Admin:</label>
												<div class="col-lg-9">
                                ...
                                <label class="col-lg-3 control-label">Company Name</label>
												<div class="col-lg-9">
                                <input type="text" id="title" class="form-control" name="company_name" placeholder="Company Name" value="<?=set_value('company_name');?>"/>
                            ...
                            <div class="form-group">
                            	<label class="col-lg-3 control-label">Company Logo</label>
												<div class="col-lg-9">
                                <input type="file" class="form-control" style="height:auto;" name="logo" id="logo">
