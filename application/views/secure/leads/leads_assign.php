                    ...
                    success:function(result){
                      console.log(result);
					   if(result.status == true){
						  ...
						  $('#convertbtn').html('<?php if(in_array('leads-assign', $this->GroupPermission)){?><a onClick="workassign('+result.data.id+')" class="btn btn-info"><i class="fa fa-mail-forward"></i> Work Assign</a><?php } if(in_array('leads-convertcustomer', $this->GroupPermission)){?>&nbsp;<a onClick="convertcustomer('+result.data.id+')" class="btn btn-success"><i class="fa fa-user"></i> Convert to Customer</a><?php }?>'); 
