		...
		<div class="col-lg-3">
			...
			<div class="panel bg-teal-400">
				<div class="panel-body">
					...
					<h3 class="no-margin"><?php $count = $this->Leads_model->get_today_reminder_list(date("Y-m-d"));
											echo count($count); ?></h3>
		...
		<div class="col-lg-3">
			...
			<div class="panel bg-pink-400">
				<div class="panel-body">
					...
					<h3 class="no-margin"><?php $count = $this->Leads_model->get_today_assignlead_list(date("Y-m-d"));
											echo count($count); ?></h3>
		...
		<div class="col-lg-3">
			...
			<div class="panel bg-blue-400">
				<div class="panel-body">
					...
					<h3 class="no-margin"><?php $mscount = $this->Leads_model->get_today_ms_list(date("Y-m-d"));
											echo count($mscount); ?></h3>
		...
		<div class="col-lg-3">
			...
			<div class="panel bg-purple-400">
				<div class="panel-body">
					...
					<h3 class="no-margin"><?php $mscount = $this->Leads_model->get_today_expire_list(date("Y-m-d"));
											echo count($mscount); ?></h3>
					Today's Expire AMC and Warrenty

				</div>
				<div class="container-fluid">
					<div id="members-online"><a href="<?= base_url('secure/leads/gettodayamclist'); ?>" style="color:#fff;">Click Here</a></div>
				</div>
			</div>
			<!-- /today's revenue -->
		</div>
