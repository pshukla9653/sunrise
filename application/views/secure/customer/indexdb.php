...
<div id="modal_default" class="modal fade" data-backdrop="false">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <?=form_open_multipart('secure/customer/add', array('class'=>'form-horizontal','id'=>'addlead')); ?>
      <?php echo $this->session->flashdata('msg'); ?>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="form-group">
              ...
              <div class="col-lg-9">
                <input type="date" id="wreminder_date" name="reminder_date" class="form-control" required/>
			...
			$.ajax({
                    ...
                    success:function(result){
					   ...
					   if(result.status == true){
						   ...
						   $('#editreminder_date').val(result.data.reminder_date);
		...
		if(id !=''){
			...
			$.ajax({
                    ...
                    success:function(result){
					   ...
					   if(result.status == true){
						  $('#modal_followup').modal('toggle');
						   $('#wreminder_date').val(result.data.reminder_on);
