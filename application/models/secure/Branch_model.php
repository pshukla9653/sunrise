...
class Branch_model extends CI_Model
{
	...
	function get_branch_list(){
			$this->db->select('tbl_branch.*,tbl_users_details.name');
			$this->db->from('tbl_branch');
			$this->db->join('tbl_users_details', 'tbl_branch.user_id=tbl_users_details.user_id');
    ...
    {
        return $this->db->get_where('tbl_branch',array('id'=>$id))->row_array();	
    }
